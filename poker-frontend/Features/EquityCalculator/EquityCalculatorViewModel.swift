...
class EquityCalculatorViewModel: CardSelectionProtocol {
  ...
  init() {
    ...
    // MARK: - Test Data
    // Start with 5 of hearts, 9 of clubs for player 1 and 8 of clubs, 7 of hearts for player 2
  ...
  func calculateWinningProbability() {
    ...
    for i: Int in 1...self.trials {
      ...
      switch determineWinner(
        player1Cards: self.player1Cards, player2Cards: self.player2Cards, tableCards: table)
      {
  ...
  func determineWinner(
    player1Cards: [CardModel], player2Cards: [CardModel], tableCards: [CardModel]
  ) -> Hand {
    ...
    if tempStraightHand.count >= 5 {
      ...
      for i in 0..<tempStraightHand.count - 4 {
        ...
        if tempStraightHand[i].rank.rank == tempStraightHand[i + 1].rank.rank + 1
          && tempStraightHand[i + 1].rank.rank + 1 == tempStraightHand[i + 2].rank.rank + 2
          && tempStraightHand[i + 2].rank.rank + 2 == tempStraightHand[i + 3].rank.rank + 3
          && tempStraightHand[i + 3].rank.rank + 3 == tempStraightHand[i + 4].rank.rank + 4
        {
          ...
          if tempStraightHand[i].suit == tempStraightHand[i + 1].suit
            && tempStraightHand[i + 1].suit == tempStraightHand[i + 2].suit
            && tempStraightHand[i + 2].suit == tempStraightHand[i + 3].suit
            && tempStraightHand[i + 3].suit == tempStraightHand[i + 4].suit
          {
    ...
    if tempStraightHand2.count > 4 {
      ...
      for i in 0..<tempStraightHand2.count - 4 {
        ...
        if tempStraightHand2[i].rank.rank == tempStraightHand2[i + 1].rank.rank + 1
          && tempStraightHand2[i + 1].rank.rank + 1 == tempStraightHand2[i + 2].rank.rank + 2
          && tempStraightHand2[i + 2].rank.rank + 2 == tempStraightHand2[i + 3].rank.rank + 3
          && tempStraightHand2[i + 3].rank.rank + 3 == tempStraightHand2[i + 4].rank.rank + 4
        {
          ...
          if tempStraightHand2[i].suit == tempStraightHand2[i + 1].suit
            && tempStraightHand2[i + 1].suit == tempStraightHand2[i + 2].suit
            && tempStraightHand2[i + 2].suit == tempStraightHand2[i + 3].suit
            && tempStraightHand2[i + 3].suit == tempStraightHand2[i + 4].suit
          {
    ...
    for i in 0..<player1FullHand.count - 3 {
      ...
      if player1FullHand[i].rank == player1FullHand[i + 1].rank
        && player1FullHand[i + 1].rank == player1FullHand[i + 2].rank
        && player1FullHand[i + 2].rank == player1FullHand[i + 3].rank
      {
      ...
      if player2FullHand[i].rank == player2FullHand[i + 1].rank
        && player2FullHand[i + 1].rank == player2FullHand[i + 2].rank
        && player2FullHand[i + 2].rank == player2FullHand[i + 3].rank
      {
    ...
    if player1ThreeOfAKind {
      ...
      for i in 0..<player1FullHand.count - 1 {
        ...
        if player1FullHand[i].rank.rank == player1FullHand[i + 1].rank.rank
          && player1FullHand[i].rank.rank != player1ThreeOfAKindRank
        {
    ...
    if player2ThreeOfAKind {
      ...
      for i in 0..<player2FullHand.count - 1 {
        ...
        if player2FullHand[i].rank.rank == player2FullHand[i + 1].rank.rank
          && player2FullHand[i].rank.rank != player2ThreeOfAKindRank
        {
    ...
    if player1Pair {
      ...
      for i in 0..<player1FullHand.count - 1 {
        ...
        if player1FullHand[i].rank.rank == player1FullHand[i + 1].rank.rank
          && player1FullHand[i].rank.rank != player1PairRank
        {
    ...
    if player2Pair {
      ...
      for i in 0..<player2FullHand.count - 1 {
        ...
        if player2FullHand[i].rank.rank == player2FullHand[i + 1].rank.rank
          && player2FullHand[i].rank.rank != player2PairRank
        {
      ...
      if player1PairRank > player2PairRank {
        ...
        if player1TwoPairRank > player2TwoPairRank {
          ...
          for card in player1FullHand {
            ...
            if card.rank.rank != player1TwoPairRank && card.rank.rank != player1PairRank
              && card.rank.rank > player1Kicker
            {
          ...
          for card in player2FullHand {
            ...
            if card.rank.rank != player2TwoPairRank && card.rank.rank != player2PairRank
              && card.rank.rank > player2Kicker
            {
    ...
    if player1Pair && player2Pair {
      ...
      if player1PairRank > player2PairRank {
        ...
        var kicker = checkKicker(
          player1FullHand: player1FullHand, player2FullHand: player2FullHand,
  ...
  func checkKicker(
    player1FullHand: [CardModel], player2FullHand: [CardModel], banned_ranks: [Int],
    completion: @escaping (Hand) -> Void
  ) -> Int {
